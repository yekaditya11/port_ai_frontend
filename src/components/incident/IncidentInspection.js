  ...
  const incidents = [
    {
      ...
      category: 'Bad road surfaces and inadequate signage',
    ...
    {
      id: 'INC03280777',
      title: 'Impacting Health',
      category: 'Minor injuries and accidents',
      subCategory: 'Injury & Ill Health',
      date: '25 Mar 2026',
      time: '01:02:32',
      location: 'Container Berth',
      subLocation: 'Berth No. 05',
      context: 'Vessel Operation',
      contextDetail: 'Cut / Laceration',
      status: 'Review',
      severity: '2-Minor',
      severityType: 'minor',
      action: 'Review',
      actionTime: '11:00:14',
      details: {
        title: 'Container Berth - Injury & Ill Health - Impacting Health - 2-Minor - 25/03/2026 - 01:02 - Martin Debeloz',
        shift: 'Shift 1',
        critical: 'No',
        reportedTo: '--',
        inspectedDateTime: '25 Mar 26 | 02:15',
        inspector: 'Martin Debeloz',
        investigationDateTime: '--',
        leadInvestigator: 'Martin Debeloz',
        reportedDateTime: '25 Mar 26 | 01:02',
        reportable: '--',
        shiftManager: 'Martin Debeloz (IDA)',
        actualSeverity: '2-Minor',
        potentialSeverity: '2-Minor',
    ...
    },
    {
      ...
      category: 'Machinery breakdowns and technical failures',
      subCategory: 'Asset Damage',
      date: '25 Mar 2026',
      time: '11:52:07',
      location: 'CFS Yard',
      subLocation: 'North Storage Area',
      context: 'Equipment Maintenance',
      contextDetail: 'Structural Collapse',
      status: 'Review',
      severity: '4-Major',
      severityType: 'major',
      action: 'Review',
      actionTime: '11:01:24',
      details: {
        title: 'CFS Yard - Asset Damage - Equipment Failure - 4-Major - 25/03/2026 - 11:52 - Martin Debeloz',
        shift: 'Shift 2',
        critical: 'Yes',
        reportedTo: '--',
        inspectedDateTime: '25 Mar 26 | 13:00',
        inspector: 'Martin Debeloz',
        investigationDateTime: '--',
        leadInvestigator: 'Martin Debeloz',
        reportedDateTime: '25 Mar 26 | 11:52',
        reportable: '--',
        shiftManager: 'Martin Debeloz (IDA)',
        actualSeverity: '4-Major',
        potentialSeverity: '4-Major',
        timeOfDay: 'Morning',
        weather: 'Sunny',
        classification: 'Work Related Incident',
        reportedBy: 'Martin Debeloz',
      ...
      <div className="content-padding" style={{ paddingTop: '10px' }}>
        <div className="incident-listing-container">
            ...
            <div className="toolbar-filters">
              ...
              <div className="filter-group" style={{ position: 'relative', flex: '1.2' }} onClick={() => setShowCalendar(!showCalendar)}>
                 <div className="filter-inner">
                    ...
                    <div className="filter-value">6 Jan | 5 Apr</div>
                 </div>
          ...
          <div className="listing-meta">
            <div className="results-count">Listing 1 - 10 OF 120</div>
