  ...
  const incidents = [
    {
      ...
      category: 'Impact on electrical and utility infrastructure',
      subCategory: 'Environmental Disaster',
      date: '25 Mar 2026',
      time: '12:15:14',
      location: 'Container & General Cargo Berth',
      subLocation: 'Berth No. 11',
      context: 'Gate Operations',
      contextDetail: 'Human Error',
      status: 'New',
      severity: '--',
      severityType: 'minor',
      action: 'Review',
      actionTime: '11:00:59',
      details: {
        title: 'Container & General Cargo Berth - Other Incident - Infrastructure Damage - 2-Minor - 25/03/2026 - 12:15 - Martin Debeloz',
        shift: 'Shift 2',
        critical: 'No',
        reportedTo: 'Craig Williams',
        inspectedDateTime: '26 Mar 26 | 18:03',
        inspector: '--',
        investigationDateTime: '--',
        leadInvestigator: 'Martin Debeloz',
        reportedDateTime: '25 Mar 26 | 12:15',
        reportable: '--',
        shiftManager: 'Martin Debeloz (IDA)',
        actualSeverity: '3-Moderate',
        potentialSeverity: '3-Moderate',
        timeOfDay: 'Afternoon',
        weather: '--',
    ...
    },
    {
      ...
      category: 'Inadequate barricading and safety protocols',
      subCategory: 'Near Miss',
      date: '24 Mar 2026',
      time: '10:53:55',
      location: 'Container Yard',
      subLocation: 'B-YARD',
      context: 'Container Yard Operations',
      contextDetail: 'Struck by Equipment',
      status: 'New',
      severity: '--',
      severityType: 'minor',
      action: 'Review',
      actionTime: '12:02:20',
      details: {
        title: 'Container Yard - Safety Violation - Near Miss - 2-Minor - 24/03/2026 - 10:53 - Martin Debeloz',
        shift: 'Shift 2',
        critical: 'No',
        reportedTo: 'Craig Williams',
        inspectedDateTime: '--',
        ...
        investigationDateTime: '--',
        leadInvestigator: 'Martin Debeloz',
        reportedDateTime: '24 Mar 26 | 10:53',
        reportable: '--',
        shiftManager: 'Martin Debeloz (IDA)',
      ...
      <div className="content-padding" style={{ paddingTop: '10px' }}>
        <div className="incident-listing-container">
          ...
          <div className="listing-meta">
            <div className="results-count">Listing 1 - 10 OF 44</div>
